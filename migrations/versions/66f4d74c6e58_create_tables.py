...
Revision ID: 66f4d74c6e58
Revises: 
Create Date: 2023-11-14 17:21:58.926897
...
def upgrade() -> None:
    ...
    op.create_table('teams_groups_workouts',
    sa.Column('team_id', sa.UUID(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_table('teams_groups_workouts')
