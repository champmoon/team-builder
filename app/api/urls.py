...
url.GET("     /trainer/profile              ", endpoint=trainers_profile.get_profile)
url.PATCH("   /trainer/profile              ", endpoint=trainers_profile.update_profile)

url.GET("     /sportsman/profile            ", endpoint=sportsmans_profile.get_profile)
url.PATCH("   /sportsman/profile            ", endpoint=sportsmans_profile.update_profile)
...
url.GET("     /trainer/groups               ", endpoint=trainers_groups.get_self_groups)
url.GET("     /trainer/groups/{id}          ", endpoint=trainers_groups.get_self_group)
url.PATCH("   /trainer/groups/{id}          ", endpoint=trainers_groups.update_group)
url.DELETE("  /trainer/groups/{id}          ", endpoint=trainers_groups.delete_group)
url.POST("    /trainer/groups               ", endpoint=trainers_groups.create_group)
url.POST("    /trainer/groups/add           ", endpoint=trainers_groups.add_sportsman_to_group)
url.POST("    /trainer/groups/adds          ", endpoint=trainers_groups.adds_sportsmans_to_group)
url.POST("    /trainer/groups/kick          ", endpoint=trainers_groups.kick_sportsman_to_group)
url.POST("    /trainer/groups/kicks         ", endpoint=trainers_groups.kicks_sportsmans_to_group)

url.GET("     /sportsman/groups             ", endpoint=sportsmans_groups.get_self_groups)
url.GET("     /sportsman/groups/{id}        ", endpoint=sportsmans_groups.get_self_group)
url.GET("     /sportsman/groups/out/{id}    ", endpoint=sportsmans_groups.out_off_group)
