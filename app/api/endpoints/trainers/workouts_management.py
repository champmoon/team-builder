...
from app.models.sportsmans_workouts import SportsmansWorkouts
...
@inject
async def get_workouts_schema(
    workout_out: Workouts,
    sportsmans_workouts_out: Sequence[SportsmansWorkouts],
    ...
    for sportsman_workout_out in sportsmans_workouts_out:
        ...
        workout_schemas.append(workout_schema)

    return workout_schemas
...
@inject
async def set_attend_yes(
    sportsmans_workout_in: schemas.SportsmansWorkoutsManagmentIn,
    ...
    workout_out = await workouts_service.get_by_id(id=sportsmans_workout_in.workout_id)
    ...
    all_sportsmans_workouts_ids = sportsmans_workout_in.sportsmans_ids
    if not all_sportsmans_workouts_ids:
        all_sportsmans_workouts_ids = [
            sportsman_workout_out.sportsman_id
            for sportsman_workout_out in (
                await sportsmans_workouts_service.get_all_by_workout_id(
                    workout_id=sportsmans_workout_in.workout_id
                )
            )
        ]
    ...
    return await get_workouts_schema(
        ...
        sportsmans_workouts_out=(
            await sportsmans_workouts_service.update(
                ids=all_sportsmans_workouts_ids, is_attend=True
            )
        ),
    )
...
async def set_attend_no(
    ...
    return await get_workouts_schema(
        ...
        sportsmans_workouts_out=(
            await sportsmans_workouts_service.update(
                ids=all_sportsmans_workouts_ids, is_attend=False
            )
        ),
    )
...
async def set_paid_yes(
    ...
    return await get_workouts_schema(
        ...
        sportsmans_workouts_out=(
            await sportsmans_workouts_service.update(
                ids=all_sportsmans_workouts_ids, is_paid=True
            )
        ),
    )
...
async def set_paid_no(
    ...
    return await get_workouts_schema(
        ...
        sportsmans_workouts_out=(
            await sportsmans_workouts_service.update(
                ids=all_sportsmans_workouts_ids, is_paid=False
            )
        ),
    )
